...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName("whoami")
    .setDescription("Bot will introduce themselves!"),
  new SlashCommandBuilder()
    .setName("whitelist")
    ...
    .addStringOption((option) =>
      option
        .setName("address")
        .setDescription(
          "Address of the Metamask wallet to add to the whitelist"
        )
        .setRequired(true)
    ),
  new SlashCommandBuilder()
    .setName("review-applications")
    .setDescription(
      "Regenerates all applications yet to review for the whitelist. Admin only."
    ),
  new SlashCommandBuilder()
